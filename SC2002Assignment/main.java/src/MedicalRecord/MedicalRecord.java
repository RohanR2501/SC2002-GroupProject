...
public class MedicalRecord {
    ...
    public void viewMedicalRecord() {
        ...
        System.out.println("Past Diagnoses: " + getDiagnoses());
        System.out.println("Treatments: " + getTreatments());
        System.out.println("Prescriptions: " + getPrescriptions());
    }
    public void updateMedicalRecord(){
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    System.out.println("Enter new treatment (or type 'done' to stop):");
                    String treatment;
